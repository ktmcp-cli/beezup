            ...
            "schema": {
              "items": {
                "enum": [
                  ...
                  "PublishOffers",
                  "Unpublish",
                  "PublishRelationshipsEnum",
                  "PublishProductImagesEnum",
                  "PublishInventoryEnum",
                  "PublishPricingEnum"
                ],
      ...
      "post": {
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/generateBatchOrderInvoiceRequest"
              }
            }
          },
          "required": true
        ...
        "responses": {
          "202": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/generateBatchOrderInvoiceResponse"
                }
              }
            },
            "description": "The locations of the generated invoice. Might take a few seconds to be available"
          },
          "400": {
            "$ref": "#/components/responses/generateBatchOrderInvoiceErrorResponse"
          },
          "403": {
        ...
        "summary": "Generate an Order Invoice batch",
        "tags": [
      ...
      "generateBatchOrderInvoiceErrorResponse": {
        "content": {
          "application/json": {
            "schema": {
              "items": {
                "$ref": "#/components/schemas/generateBatchOrderInvoiceErrorResponseItem"
              },
              "type": "array"
            }
          }
        },
        "description": "GenerateBatchOrderInvoiceErrorResponse"
      },
    ...
    "schemas": {
          ...
          "details": {
            "properties": {
              ...
              "subscriptionLink": {
                ...
                "example": "By Email at : stephanie.gregis@m6.fr\n",
                "type": "string"
              },
              "trackingType": {
      ...
      "generateBatchOrderInvoiceErrorResponseItem": {
        "properties": {
          ...
          "errors": {
            "$ref": "#/components/schemas/generateBatchOrderInvoiceErrorResponseItemDetails"
          }
        },
        "required": [
          "errorType",
      ...
      "generateBatchOrderInvoiceErrorResponseItemDetail": {
        "properties": {
          ...
          "request": {
            "$ref": "#/components/schemas/generateBatchOrderInvoiceRequestItem"
          }
        },
        "type": "object"
      },
      "generateBatchOrderInvoiceErrorResponseItemDetails": {
        "items": {
          "$ref": "#/components/schemas/generateBatchOrderInvoiceErrorResponseItemDetail"
        },
        "type": "array"
      },
      ...
      "generateBatchOrderInvoiceRequestItem": {
        "properties": {
          "accountId": {
            "$ref": "#/components/schemas/marketplaceAccountId"
          },
          "beezUPOrderUUID": {
            "$ref": "#/components/schemas/beezUPOrderUUID"
          },
          "invoiceSequenceNumber": {
            "$ref": "#/components/schemas/invoiceSequenceNumber"
          },
          "marketplaceTechnicalCode": {
            "$ref": "#/components/schemas/marketplaceTechnicalCode"
          }
        },
        "required": [
          "marketplaceTechnicalCode",
      ...
      "generateBatchOrderInvoiceResponse": {
        "items": {
          "$ref": "#/components/schemas/generateOrderInvoiceResponse"
        },
        "type": "array"
      },
